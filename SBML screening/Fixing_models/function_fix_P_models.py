"""
function to fix the Propionibacterium models
"""
...
def fix_P_models_sbml(modelName, boundATPm, saveName):
    '''
    This script intends to fix the SBML (GEMs) of "P_XXXX_model.xml"
    Propionibacterium XXXX
    ...
    lbATPm = boundATPm  # 3.15 # mmol/gDW/h
    ...
    # save the model
    newModelName = r"C:\Users\lucas\PycharmProjects\Alquimia\SBML models\{}".format(saveName)
